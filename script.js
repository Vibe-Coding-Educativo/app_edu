document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- DOM Elements ---
    // Ahora esta constante se inicializa cuando el DOM está listo.
    const elements = {
